...
- Provider review screen: edit + approve; approved text stored and frozen.
- Gate test: nothing renders unapproved text.
...
- Patient results page (S4): overall box, range markers, per-test text, MedlinePlus links,
  disclaimer, critical/implausible/unknown states.
